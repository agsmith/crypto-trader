...
def go():
    ...
    book = BookOfBusiness(bulls=[], bears=Structures.symbols, current_value=0.00, portfolio=Structures.portfolio)
    ...
    print("______Current Value_________")
    print(book.current_value)
